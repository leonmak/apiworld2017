...
struct Constants {
    ...
    static let contractorPath: [CLLocation] = [
        ...
        CLLocation(latitude: 37.73397949, longitude: -122.422169),
        CLLocation(latitude: 37.73394555, longitude: -122.422218),
        CLLocation(latitude: 37.73389889, longitude: -122.422271),
        CLLocation(latitude: 37.73384798, longitude: -122.422352),
        ...
        CLLocation(latitude: 37.73449708, longitude: -122.423207),
        CLLocation(latitude: 37.73449284, longitude: -122.423178),
        CLLocation(latitude: 37.73448859, longitude: -122.423191),
        CLLocation(latitude: 37.73450556, longitude: -122.423186)
    ]
}
